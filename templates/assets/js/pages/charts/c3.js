c3.generate({
    ...
    data: {
        columns: [
            // each columns data
            ['data1', 20, 80, 60, 77, 14, 91],
            ['data2', 75, 65, 77, 100, 100, 75],
            ['data3', 90, 100, 100, 85, 73, 80]
        ],
...
c3.generate({
    ...
    data: {
        columns: [
            // each columns data
            ['data1', 200, 320, 230, 340, 450, 300, 435],
            ['data2', 470, 247, 355, 417, 569, 518,456],
            ['data3', 250, 345, 645, 287, 367, 412,252],
            ['data4', 670, 527, 355, 461, 468, 502,456],
        ],
